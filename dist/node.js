 ...
 */
async function getNodeKeyPair(cfg) {
 ...
 */
function startLeaderNode(chain, cfg, kp, errorHandler) {
...
async function startNode() {
    try {
        ...
        errorHandler.logError(err instanceof Error ? err : new Error(String(err)), 'Node Initialization');
        process.exit(1);
    }
}
// Start the node
